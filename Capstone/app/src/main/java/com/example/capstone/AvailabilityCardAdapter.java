...
public class AvailabilityCardAdapter extends ArrayAdapter<Availability> {

    private Context context;
    private ArrayList<Availability> availabilities;

    public AvailabilityCardAdapter(Context context, ArrayList<Availability> availabilities){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ((TextView)teacherCard.findViewById(R.id.name)).setText(currentAvailabilities.getDate());
